...
REM
REM Generated by Vivado on Wed Sep 02 08:41:12 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj counter4_vlog.prj"
call xvlog  --incr --relax -L uvm -prj counter4_vlog.prj -log xvlog.log
